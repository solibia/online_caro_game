...
public class Client extends javax.swing.JFrame {
    ...
    //cette socket est résevé pour connecter à server
    Socket socket=null;
     ...
     */
    public Client() {
        //Capture l'address IP du server
        host = JOptionPane.showInputDialog("IP server", "127.0.0.1");
    ...
    private void initComponents() {
        ...
        jLabel4.setText("You are client");
...
//Capturer l'événement lorsque l'utilisateur clicke sur l'écran
    private void MouseClick(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_MouseClick
        //Verifier si ce joueur a le droit à jouer
        if(!myturn) return;        
        else{
            //votre tour
